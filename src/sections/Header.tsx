  ...
  return (
    ...
    <div className="flex justify-center items-center py-3 bg-black text-white text-sm gap-3">
      ...
      <div className='inline-flex gap-1 items-center'>
        <p>Get started for free, whatsapp us: +91 974-828-4985</p>
      ...
      <div className='container'>
        <div className='flex items-center justify-between'>
          ...
          <nav className='hidden md:flex gap-6 text-black/60 items-center'>
            <a href='/' className='text-cyan-900'>Home</a>
            <a href='#'>Features</a>
            <a href='#'>Customers</a>
            <a href='#'>Services</a>
            <a href='#'>Contact</a>
            <button className="inline-flex h-9 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"><a href="https://navdisenyo1.zohobookings.com/#/navdisenyo">Appointment</a></button>
          </nav>
        </div>
      </div>
    </div>
